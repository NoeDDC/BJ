...
const RIDDLES = [
  ...
  { q: "Plus j'en fais, plus j'en laisse derrière moi. Qu'est-ce que c'est ?",
    a: "des pas",       alt: ["des empreintes", "des traces", "des traces de pas"],
  ...
  // ── nature et ciel ──
  { q: "Je te suis partout en plein jour et je disparais dès qu'il fait nuit. Qui suis-je ?",
    a: "ton ombre",        alt: ["les ombres"],
    hint: "Au coucher du soleil, elle devient immense." },
  { q: "On me sent, on m'entend, mais personne ne m'a jamais vu. Qui suis-je ?",
    a: "le vent",          alt: ["le souffle", "la brise"],
    hint: "C'est lui qui fait claquer les volets la nuit." },
  { q: "Plus on me nourrit, plus je grandis ; donne-moi à boire et je meurs. Qui suis-je ?",
    a: "le feu",           alt: ["la flamme", "les flammes", "un incendie"],
    hint: "Il lui faut du bois et une allumette." },
  { q: "J'ai un lit mais je n'y dors jamais. Qui suis-je ?",
    a: "une rivière",      alt: ["les rivières", "un fleuve", "un ruisseau"],
    hint: "Elle va vers la mer sans jamais s'arrêter en route." },
  { q: "Je voyage sans valise et je pleure sans être triste. Qui suis-je ?",
    a: "un nuage",         alt: ["les nuages"],
    hint: "Il passe devant le soleil au mauvais moment." },
  { q: "Je tombe en silence et je repeins tout en blanc. Qui suis-je ?",
    a: "la neige",         alt: ["un flocon", "les flocons"],
    hint: "Elle transforme la ville en une seule nuit." },
  { q: "Je tambourine sur les toits sans avoir de baguettes. Qui suis-je ?",
    a: "la pluie",         alt: ["les pluies", "une averse"],
    hint: "C'est elle qui rend les dimanches plus doux." },
  { q: "Je ne me montre qu'entre deux averses, et jamais deux fois au même endroit. Qui suis-je ?",
    a: "un arc-en-ciel",   alt: ["les arcs-en-ciel"],
    hint: "Il faut de la pluie et du soleil en même temps." },
  { q: "Je brille de si loin que ma lumière est peut-être déjà éteinte. Qui suis-je ?",
    a: "une étoile",       alt: ["les étoiles", "un astre"],
    hint: "On les compte en levant la tête, les soirs d'été." },
  { q: "Je change de forme chaque nuit sans jamais changer de place. Qui suis-je ?",
    a: "la lune",          alt: [],
    hint: "Elle est pleine une fois par mois." },
  { q: "Je me lève sans jambes et je me couche sans lit. Qui suis-je ?",
    a: "le soleil",        alt: [],
    hint: "Il commence toujours par l'est." },
  { q: "Je monte toujours et je ne redescends jamais. Qui suis-je ?",
    a: "la fumée",         alt: ["les fumées"],
    hint: "Elle sort par la cheminée." },
  { q: "Plus tu me serres fort, plus je m'échappe. Qui suis-je ?",
    a: "le sable",         alt: [],
    hint: "Il reste dans les poches longtemps après la plage." },
  { q: "J'ai des vagues sans cheveux et du sel sans cuisine. Qui suis-je ?",
    a: "la mer",           alt: ["l'océan", "les mers"],
    hint: "On l'entend dans les coquillages." },
  { q: "Je tombe chaque soir et pourtant personne ne me relève. Qui suis-je ?",
    a: "la nuit",          alt: ["le soir", "la tombée de la nuit"],
    hint: "Après elle, les compteurs repartent à zéro." },

  // ── objets du quotidien ──
  { q: "Plus je sèche, plus je suis mouillée. Qui suis-je ?",
    a: "une serviette",    alt: ["les serviettes", "un torchon"],
    hint: "Elle t'attend juste à la sortie de la douche." },
  { q: "Je suis plein de trous et pourtant je retiens l'eau. Qui suis-je ?",
    a: "une éponge",       alt: ["les éponges"],
    hint: "Elle habite au bord de l'évier." },
  { q: "Qu'est-ce qui monte quand la pluie descend ?",
    a: "un parapluie",     alt: ["les parapluies", "un pépin"],
    hint: "On l'oublie systématiquement quelque part." },
  { q: "Je n'ai ni début ni fin, et pourtant on me porte au doigt. Qui suis-je ?",
    a: "une bague",        alt: ["les bagues", "un anneau", "une alliance"],
    hint: "Elle se glisse à l'annulaire." },
  { q: "Plus on m'enlève, plus je grandis. Qui suis-je ?",
    a: "un trou",          alt: ["les trous"],
    hint: "Une pelle en fabrique très vite." },
  { q: "Je tourne sans danser et j'ouvre sans mains. Qui suis-je ?",
    a: "une clé",          alt: ["les clés", "une clef", "les clefs"],
    hint: "Tu la cherches toujours au moment de partir." },
  { q: "Plus je brûle, plus je rapetisse. Qui suis-je ?",
    a: "une bougie",       alt: ["les bougies", "une chandelle"],
    hint: "On en souffle une de plus chaque année." },
  { q: "Plus je travaille, plus je raccourcis. Qui suis-je ?",
    a: "un crayon",        alt: ["les crayons", "une mine"],
    hint: "Il a une gomme au bout." },
  { q: "Je te montre exactement tel que tu es, sans jamais dire un mot. Qui suis-je ?",
    a: "un miroir",        alt: ["les miroirs", "une glace"],
    hint: "Il est accroché au-dessus du lavabo." },
  { q: "J'ai une idée à chaque fois qu'on m'allume. Qui suis-je ?",
    a: "une ampoule",      alt: ["les ampoules", "une lampe"],
    hint: "Dans les bandes dessinées, elle s'affiche au-dessus des têtes." },
  { q: "Je sonne sans être une cloche et je te réveille sans être le matin. Qui suis-je ?",
    a: "un téléphone",     alt: ["les téléphones", "un portable", "un smartphone"],
    hint: "Tu l'as dans la main, là, maintenant." },
  { q: "J'arrête le temps sans jamais réussir à le retenir. Qui suis-je ?",
    a: "une photo",        alt: ["les photos", "une photographie", "un cliché"],
    hint: "On en a des milliers qu'on ne rouvre jamais." },
  { q: "Je fais pleurer sans jamais faire de mal. Qui suis-je ?",
    a: "un oignon",        alt: ["les oignons"],
    hint: "On le coupe en larmes, pour la soupe." },
  { q: "Je me casse sans qu'on puisse me réparer, et pourtant je contiens la vie. Qui suis-je ?",
    a: "un oeuf",          alt: ["les oeufs"],
    hint: "À la coque, il se mange avec des mouillettes." },
  { q: "Je plonge sans me noyer et je ressors toujours pleine. Qui suis-je ?",
    a: "une cuillère",     alt: ["les cuillères", "une cuiller", "une petite cuillère"],
    hint: "Elle tourne dans la tasse, le matin." },
  { q: "Noir et brûlant, je fais semblant de te réveiller. Qui suis-je ?",
    a: "le café",          alt: ["les cafés", "un expresso"],
    hint: "Sans lui, la matinée n'existe pas vraiment." },
  { q: "Je pars toujours à deux et je reviens souvent seule de la machine. Qui suis-je ?",
    a: "une chaussette",   alt: ["les chaussettes"],
    hint: "La machine en avale une sur deux." },
  { q: "On me cherche partout alors que je suis posée sur ton front. Qui suis-je ?",
    a: "des lunettes",     alt: ["une paire de lunettes"],
    hint: "Elles finissent toujours dans les cheveux." },
  { q: "Je voyage collé dans un coin et je fais le tour du monde. Qui suis-je ?",
    a: "un timbre",        alt: ["les timbres"],
    hint: "En haut à droite de l'enveloppe." },
  { q: "Je raconte mille vies sans en avoir vécu une seule. Qui suis-je ?",
    a: "un livre",         alt: ["les livres", "un roman", "un bouquin"],
    hint: "Il y en a une pile qui attend sur la table de nuit." },
  { q: "Il me manque toujours une pièce, et toujours au pire moment. Qui suis-je ?",
    a: "un puzzle",        alt: ["les puzzles"],
    hint: "Son émoji est en haut à gauche de cette app." },
  { q: "Je perds une page chaque mois sans jamais m'en plaindre. Qui suis-je ?",
    a: "un calendrier",    alt: ["les calendriers", "un agenda", "un almanach"],
    hint: "Il y a un onglet entier pour ça, juste en bas." },
  { q: "Plus je pars loin, plus je deviens lourde. Qui suis-je ?",
    a: "une valise",       alt: ["les valises", "un bagage", "un sac"],
    hint: "On la fait toujours la veille au soir, trop tard." },
  { q: "J'ai deux roues et je ne tiens debout qu'en avançant. Qui suis-je ?",
    a: "un vélo",          alt: ["les vélos", "une bicyclette"],
    hint: "Ça ne s'oublie jamais, paraît-il." },

  // ── lieux ──
  { q: "Je vais absolument partout sans jamais bouger d'un pas. Qui suis-je ?",
    a: "une route",        alt: ["les routes", "un chemin", "une rue"],
    hint: "C'est elle qui mène de chez toi à chez moi." },
  { q: "Je relie deux rives sans jamais toucher l'eau. Qui suis-je ?",
    a: "un pont",          alt: ["les ponts"],
    hint: "On se retrouve souvent au milieu." },
  { q: "Je suis toujours entre deux mondes et je ne choisis jamais. Qui suis-je ?",
    a: "une porte",        alt: ["les portes"],
    hint: "On frappe avant d'entrer." },
  { q: "Je laisse entrer le jour sans laisser entrer la pluie. Qui suis-je ?",
    a: "une fenêtre",      alt: ["les fenêtres", "une vitre", "un carreau"],
    hint: "On l'ouvre en grand le matin, pour aérer." },
  { q: "J'ai des murs sans être une prison et un toit sans être le ciel. Qui suis-je ?",
    a: "une maison",       alt: ["les maisons", "un chez-soi", "un foyer", "un appartement"],
    hint: "C'est l'endroit où on enlève ses chaussures." },
  { q: "Je t'attends toute la journée sans jamais me plaindre. Qui suis-je ?",
    a: "un lit",           alt: ["les lits"],
    hint: "Le dimanche, on a un mal fou à le quitter." },
  { q: "Je garde tous tes secrets de la nuit et je n'en répète aucun. Qui suis-je ?",
    a: "un oreiller",      alt: ["les oreillers", "un coussin", "une taie d'oreiller"],
    hint: "On dit qu'il porte conseil." },

  // ── choses qu'on ne touche pas ──
  { q: "Je passe sans bouger et je guéris sans soigner. Qui suis-je ?",
    a: "le temps",         alt: [],
    hint: "On dit qu'il finit par arranger les choses." },
  { q: "Je me comprends dans toutes les langues et je n'ai jamais rien appris. Qui suis-je ?",
    a: "un sourire",       alt: ["les sourires"],
    hint: "Tu en as sûrement un en lisant ça." },
  { q: "Je suis contagieux et aucun médecin ne me soigne. Qui suis-je ?",
    a: "le rire",          alt: ["les rires", "un fou rire"],
    hint: "Il éclate toujours au pire moment, là où il faut se taire." },
  { q: "Je n'existe que les yeux fermés. Qui suis-je ?",
    a: "un rêve",          alt: ["les rêves", "un songe"],
    hint: "Deux minutes après avoir ouvert les yeux, il s'est déjà évaporé." },
  { q: "Je bats sans me battre et je me serre sans mains. Qui suis-je ?",
    a: "le coeur",         alt: [],
    hint: "Il s'emballe quand il voit arriver quelqu'un." },
  { q: "Je ne coûte rien, je ne dure qu'un instant, et je reste des années. Qui suis-je ?",
    a: "un baiser",        alt: ["les baisers", "un bisou", "les bisous"],
    hint: "Il se donne sans jamais se perdre." },
  { q: "Je me donne à deux et je réchauffe sans feu. Qui suis-je ?",
    a: "un câlin",         alt: ["les câlins", "une étreinte"],
    hint: "Rien de tel après une mauvaise journée." },
  { q: "Je grandis en vieillissant et je change sans qu'on me touche. Qui suis-je ?",
    a: "un souvenir",      alt: ["les souvenirs", "la mémoire"],
    hint: "Il embellit à chaque fois qu'on le raconte." },
  { q: "Je ne sers à rien tant que personne ne me pose. Qui suis-je ?",
    a: "une question",     alt: ["les questions"],
    hint: "Tu viens d'en lire une." },
  { q: "Je cours plus vite que la vérité, mais je finis toujours par m'essouffler. Qui suis-je ?",
    a: "un mensonge",      alt: ["les mensonges"],
    hint: "On dit qu'il a de courtes jambes." },
  { q: "Je m'installe sans qu'on m'invite et je repars en traînant des pieds. Qui suis-je ?",
    a: "une habitude",     alt: ["les habitudes", "la routine"],
    hint: "Il paraît qu'il faut vingt et un jours pour m'installer." },
  { q: "Je sors des yeux quand le cœur est trop plein. Qui suis-je ?",
    a: "une larme",        alt: ["les larmes", "les pleurs"],
    hint: "Il y en a aussi quand on rit trop fort." },
  { q: "Je reste dans ta tête sans que personne ne m'y ait invitée. Qui suis-je ?",
    a: "une chanson",      alt: ["les chansons", "la musique", "un air"],
    hint: "C'est celle que tu fredonnes sans t'en rendre compte." },
  { q: "Je suis long à venir et court à perdre. Qui suis-je ?",
    a: "la patience",      alt: ["le calme", "le sang-froid"],
    hint: "Elle a des limites, et tu connais très bien les tiennes." },
  { q: "Tout seul je ne vaux rien, mais je rends les autres dix fois plus grands. Qui suis-je ?",
    a: "un zéro",          alt: ["les zéros", "le chiffre zéro"],
    hint: "Colle-moi à droite d'un 1 et regarde ce qu'il devient." },
  { q: "Je suis au début de la nuit, au milieu de la lune et à la fin du matin. Qui suis-je ?",
    a: "la lettre N",      alt: ["n"],
    hint: "Ce n'est pas un objet : épelle « nuit », « lune », « matin » et observe." },
];
...
function normalizeAnswer(s) {
  return (s || '')
    .toLowerCase()
    // Les ligatures n'ont pas de d\u00e9composition canonique : sans \u00e7a \u00ab \u0153uf \u00bb
    // perdrait son \u0153 \u00e0 l'\u00e9tape ponctuation et ne vaudrait plus \u00ab oeuf \u00bb.
